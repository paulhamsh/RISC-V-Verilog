          ...
          beq x3, x2, 4            // 0c beq branch to jump if x0==x2, pcnew= pc 4 offset<<2 = 28 => offset = 1  will not branch {jump 52}
          bne x3, x2, 0            // 0d bne branch to jump if x0!=x2, pcnew= pc 4 offset<<2 = 28 => offset = 0  will branch {jump 52}
          jmp 0                    // 0e j jump to the beginning address {jump 56}
