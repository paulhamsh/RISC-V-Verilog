  ...
  always 
    begin
      ...
      `check_reg(1, 32'h0000_0048, "jalr fail - store return address", 
                 "jalr success - store return address");   
...
`elsif PROG_INDIV
   ...
   always 
     begin
       ...
       `set_memw(4, 32'h7777_7777); 
       `set_reg(2, 32'h0004);  
       `set_reg(1, 32'h9999_9998);  
       `run_step;
       `show_memw(4);
       `check_memw(4, 32'h7777_9998, "sh failure", "sh succcess");   
 
       // Test sh x1, [0 + x2]       
       // Objective - show sh only updates upper two bytes in memory
       //                sh rs2, rs1(ext_imm)
       //                +++imm+_+rs2+_+rs1+_001_+imm+_++op+++ 
       `set_pc(0);                                            
       `set_instr(0, 32'b0000000_00001_00010_001_00000_0100011);
       `set_memw(4, 32'h7777_7777); 
       `set_reg(2, 32'h0006);  
       `set_reg(1, 32'h9998_9796);  
       `run_step;
       `show_memw(4);
       `check_memw(4, 32'h9796_7777, "sh failure", "sh succcess");   
       ...
       `set_instr(0, 32'b0000000_00001_00010_001_00000_0100011);
       `set_memw(4, 32'h7777_7777); 
       `set_memw(8, 32'h8888_8888);
       `set_reg(2, 32'h0007);  
       `set_reg(1, 32'h9998_9796);  
       `run_step;
       `show_memw(4);
       `check_memw(4, 32'h9677_7777, "sh failure", "sh succcess");    
       `check_memw(8, 32'h8888_8897, "sh failure", "sh succcess");   
 
      // Test sb x1, [0 + x2]       
      // Objective - show sb only updates the lower byte in memory
      //                sb rs2, rs1(ext_imm)
      //                +++imm+_+rs2+_+rs1+_001_+imm+_++op+++ 
      `set_pc(0);                                            
      `set_instr(0, 32'b0000000_00001_00010_000_00000_0100011);
      `set_memw(4, 32'h7777_7777); 
      `set_reg(2, 32'h0004);  
      `set_reg(1, 32'h9998_9796);  
      `run_step;
      `show_memw(4);
      `check_memw(4, 32'h7777_7796, "sb failure", "sb succcess");          
       
       // Test sb x1, [0 + x2]       
       // Objective - show sb only updates the second byte in memory
       //                sb rs2, rs1(ext_imm)
       //                +++imm+_+rs2+_+rs1+_001_+imm+_++op+++ 
       `set_pc(0);                                            
       `set_instr(0, 32'b0000000_00001_00010_000_00000_0100011);
       ...
       `run_step;
       `show_memw(4);
       `check_memw(4, 32'h7777_9677, "sb failure", "sb succcess");          
       
        // Test sb x1, [0 + x2]       
        // Objective - show sb only updates the third byte in memory
        //                sb rs2, rs1(ext_imm)
        //                +++imm+_+rs2+_+rs1+_001_+imm+_++op+++ 
        `set_pc(0);                                            
        `set_instr(0, 32'b0000000_00001_00010_000_00000_0100011);
        ...
        `show_memw(4);
        `show_memw(8);
        `check_memw(4, 32'h7796_7777, "sb failure", "sb succcess");          
         
         // Test sb x1, [0 + x2]       
         // Objective - show sb only updates the upper byte in memory
         //                sb rs2, rs1(ext_imm)
         //                +++imm+_+rs2+_+rs1+_001_+imm+_++op+++ 
         `set_pc(0);                                            
         `set_instr(0, 32'b0000000_00001_00010_000_00000_0100011);
         ...
         `run_step;
         `show_memw(4);
         `check_memw(4, 32'h9677_7777, "sb failure", "sb succcess");   
