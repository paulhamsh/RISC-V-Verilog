           000000000000_00010_000_00011_0000011 // 00 load x0 <- mem x2   0                  alu_op = 000  x0 = 1 mem 0   0
           000000000100_00010_000_00001_0000011 // 01 load x1 <- mem x2   4                  alu_op = 000  x1 = 2 mem 0   4
         000000_0_00001_00011_000_00010_0001011 // 02 add x2 <- x0   x1                       alu_op = 000  x2 = 3
          0000000_00010_00001_000_00000_0000111 // 03 store mem x1   0 <- x2                 alu_op = 000  mem 4   0 = 3
        ...
        0_000000_00010_00011_000_0010_0_0101111 // 0c beq branch to jump if x0==x2, pcnew= pc 4 offset<<2 = 28 => offset = 1  will not branch 
        0_000000_00010_00011_000_0000_0_0110011 // 0d bne branch to jump if x0!=x2, pcnew= pc 4 offset<<2 = 28 => offset = 0  will branch 
          0_0000000000_0_00000000_00000_0110111 // 0e j jump to the beginning address
